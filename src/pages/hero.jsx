      ...
      <div className="h-full w-full overflow-clip" id="herodiv">
        ...
        <div className="w-full h-[75%] flex">
          <div className="w-[60%] h-[100%]  p-6">
            ...
            <div className="w-full h-auto mb-10 text-gray-300 text-m">
              <TypeAnimation
                sequence={[
            ...
            <div className="w-full h-auto flex gap-6">
              <div className="w-1/2 h-[12rem] rounded-xl bg-gradient-to-r from-blue-500 to-blue-800 hover:bg-gradient-to-r hover:from-red-400 hover:to-red-600 hover:cursor-pointer transition-colors flex flex-col"></div>
              <div className="w-1/2 h-[12rem] rounded-xl bg-gradient-to-r from-blue-800 to-blue-500 hover:bg-gradient-to-r hover:from-red-600 hover:to-red-400 transition-colors hover:cursor-pointer "></div>
            </div>
          </div>
